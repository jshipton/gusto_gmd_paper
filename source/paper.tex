...
and motivate the use of Form Manipulation Language (FML) that
...
$\theta$ is discontinuous. Here we have chosen, as in \ref{}, to take
the average value of $\Pi$ across the facets, $\avg{\Pi} =
(\Pi^++\Pi^-)/2$, where the $+$ and $-$ indicate each side fo the
