...
the velocity $\MM{u} \in \mathbb{V}^{HDiv}$ with $\mathbb{V}^{HDiv}
\subset H(\text{div})$. **mention bcs here! The field whose gradient
appears in the `pressure' gradient term is chosen to be in the space
