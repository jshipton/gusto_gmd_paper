...
the laplacian of the prognostic field, which in all cases is not
globally defined for the finite element function spaces we use in this
paper. Here we present the symmetric interior penalty discretisation
method \citep{cockburn2007note} applied to the viscous term that we
add to the prognostic velocity equation when required. This method can
be adapted to apply to scalar fields when required.
