...
optional value, defaulting to \texttt{True} which indicates the
presence of the label. Labels can also be used to tag parts of the
...
label can be attached to a term. The end result of labelling the terms
in the residual is a \texttt{LabelledForm} object that holds a list of
