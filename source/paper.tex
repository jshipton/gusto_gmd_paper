...
\citet{natale2016compatible} we integrate by parts in each element $e$,
giving
...
required in the transport term is not well defined. As described in
\citet{yamazaki2017vertical}, a stable discretisation of this equation
can be constructed by using a combination of the above upwinding
strategy in the discontinuous horizontal direction and a
streamline-upwind Petrov-Galerkin (SUPG) method
\citep{brooks1982streamline} in the continuous vertical dirction. The
