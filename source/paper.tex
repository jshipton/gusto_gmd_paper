...
discontinuous, but this means that we now have a differential operator
applied to $\theta \in \mathbb{V}_\theta$ which is discontinuous in
the vertical. Following \ref{} we integrate by parts in each element
$e$, giving
