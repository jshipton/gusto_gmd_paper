...
field_names = ['Y', 'Y',
               'Y2', 'Y2',
               'Y_plus_Y2_plus_Y2', 'Y_plus_Y2_plus_Y2']
time_idxs = [0, -1,
             0, -1,
             0, -1]
cbars = [False, True,
...
for i, (time_idx, field_name) in enumerate(zip(time_idxs, field_names)):
    ...
    if field_name == 'Y_plus_Y2_plus_Y2':
        field_data -= 4.0e-6
